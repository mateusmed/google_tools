...
declare namespace GoogleAppsScript {
  namespace Script {
    /**
     * An enumeration that identifies which categories of authorized dao Apps Script is able to
     ...
     * dao, and to provide the URL for an authorization dialog. If the script is published as an add-on that uses installable triggers, this information can be used
